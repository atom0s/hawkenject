...
public:
	...
	struct FPointer                                    HashNext;                                                 // 0x0004(0x0004) (Const, Native, EditConst)
	struct FQWord                                      ObjectFlags;                                              // 0x0008(0x0008) (Const, Native, EditConst)
	struct FPointer                                    HashOuterNext;                                            // 0x0010(0x0004) (Const, Native, EditConst)
	struct FPointer                                    StateFrame;                                               // 0x0014(0x0004) (Const, Native, EditConst)
	class UObject*                                     Linker;                                                   // 0x0018(0x0004) (Const, Native, EditConst, NoExport)
	struct FPointer                                    LinkerIndex;                                              // 0x001C(0x0004) (Const, Native, EditConst, NoExport)
	int                                                ObjectInternalInteger;                                    // 0x0020(0x0004) (Const, Native, EditConst, NoExport)
	...
	{
		return GetVFunction<void(__thiscall *)(UObject*, class UFunction*, void*)>(this, 72)(this, function, parms);
	}


	int SortFuncFloatDesc(float A, float B);
	int SortFuncFloatAsc(float A, float B);
	int SortFuncIntDesc(int A, int B);
	int SortFuncIntAsc(int A, int B);
	int SortFuncByteDesc(unsigned char A, unsigned char B);
	int SortFuncByteAsc(unsigned char A, unsigned char B);
	...
	void AllObjectProperties(class UClass* PropertyClass, class UClass* MetaClass, bool bIncludeInheritedProperties, class UObjectProperty** ObjectProp, class UObject** PropertyValue, int* ArrayIndex);
	void AllProperties(class UClass* PropertyClass, bool bIncludeInheritedProperties, class UProperty** P, struct FString* PropertyValue, int* ArrayIndex);
	...
	struct FString STATIC_GetRegion();
	...
	struct FString STATIC_ConcatArray(const struct FString& delim, bool bIgnoreBlanks, TArray<struct FString>* StringArray);
	...
	struct FRotator STATIC_Denormalize(const struct FRotator& Rot);
	...
	float GetOrientationBetweenVectors(const struct FVector& A, const struct FVector& B);
...
public:
	...
	TArray<struct FString>                             Paths;                                                    // 0x0078(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             SeekFreePCPaths;                                          // 0x0084(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             ScriptPaths;                                              // 0x0090(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             FRScriptPaths;                                            // 0x009C(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             CutdownPaths;                                             // 0x00A8(0x000C) (Config, NeedCtorLink)
	TArray<struct FName>                               Suppress;                                                 // 0x00B4(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             Extensions;                                               // 0x00C0(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             SeekFreePCExtensions;                                     // 0x00CC(0x000C) (Config, NeedCtorLink)
	TArray<struct FString>                             LocalizationPaths;                                        // 0x00D8(0x000C) (Config, NeedCtorLink)
	struct FString                                     TextureFileCacheExtension;                                // 0x00E4(0x000C) (Config, NeedCtorLink)
...
// 0x00A4 (0x0210 - 0x016C)
class ULinkerSave : public ULinker
{
public:
	unsigned char                                      UnknownData00[0xA4];                                      // 0x016C(0x00A4) MISSED OFFSET
...
// 0x0600 (0x076C - 0x016C)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[0x600];                                     // 0x016C(0x0600) MISSED OFFSET
