...
#define CONST_TRACEFLAG_SkipPawns 64
#define CONST_TRACEFLAG_IndicatorVisibility 32
...
#define CONST_MAXPOSITIONERRORSQUARED 9.0
...
#define CONST_GAMEEVENT_PLAYERSTART_RATING 111
#define CONST_GAMEEVENT_ITEM_USED 120
...
#define CONST_NUM_PATHFINDING_PARAMS 10
...
#define CONST_ROOF_MINZ 0.7
    ...
    enum class EOnlineServerConnectionStatus : uint8_t
    {
        ...
        OSCS_InvalidUser            = 8,
        OSCS_InvalidPassword        = 9,
        OSCS_AccountDeactivated     = 10,
        OSCS_AccountLocked          = 11,
        OSCS_MAX                    = 12
    };
    ...
    // Enum Engine.ApexGridComponent.EGridResolution
    enum class EGridResolution : uint8_t
    {
        EGR     = 0,
        EGR01   = 1,
        EGR02   = 2,
    ...
    // Enum Engine.PlayerController.EProgressMessageSubType
    enum class EProgressMessageSubType : uint8_t
    {
        PMST_None                   = 0,
        PMST_ConnectionRefused      = 1,
        PMST_ConnectionTimeout      = 2,
        PMST_ClientOutdated         = 3,
        PMST_ServerOutdated         = 4,
        PMST_CreateMatchError       = 5,
        PMST_NetworkInitFailed      = 6,
        PMST_ListenError            = 7,
        PMST_PendingConnectFailed   = 8,
        PMST_LoadMapFailed          = 9,
        PMST_ServerConnectionClosed = 10,
        PMST_FailedFindPackage      = 11,
        PMST_PackageMismatched      = 12,
        PMST_MissingPackage         = 13,
        PMST_PackageNotALevel       = 14,
        PMST_InvalidUrl             = 15,
        PMST_Kicked                 = 16,
        PMST_DownloadFailed         = 17,
        PMST_MAX                    = 18
    };
    ...
    // Enum Engine.Oculus.EMouseAimMode
    enum class EMouseAimMode : uint8_t
    {
        OMA_Normal   = 0,
        OMA_Separate = 1,
        OMA_MAX      = 2
    ...
    // Enum Engine.Oculus.EOculusDevice
    enum class EOculusDevice : uint8_t
    {
        OCDev_TrackerSensor = 0,
        OCDev_LatencyTester = 1,
        OCDev_HMD           = 2,
        OCDev_MAX           = 3
    };

    // Enum Engine.Oculus.EOculusDevStatus
    enum class EOculusDevStatus : uint8_t
    {
        OCDevSt_Unknown  = 0,
        OCDevSt_Attached = 1,
        OCDevSt_Detached = 2,
    ...
    // Enum Engine.OnlineGameSettings.EOnlineMatchState
    enum class EOnlineMatchState : uint8_t
    {
        OMS_UNAVAILABLE = 0,
        OMS_PREMATCH    = 1,
        OMS_INPROGRESS  = 2,
    ...
    // Enum Engine.OnlineStreamingInterface.StreamState
    enum class EStreamState : uint8_t
    {
        StreamState_Uninitialized       = 0,
        StreamState_Initialized         = 1,
        StreamState_Authenticating      = 2,
        StreamState_Authenticated       = 3,
        StreamState_LoggingIn           = 4,
        StreamState_LoggedIn            = 5,
        StreamState_FindingIngestServer = 6,
        StreamState_FoundIngestServer   = 7,
        StreamState_ReadyToStream       = 8,
        StreamState_Streaming           = 9,
        StreamState_Paused              = 10,
        StreamState_MAX                 = 11
    };
    ...
    // Enum Engine.SoundNodeWave.EForcedWavePriority
    enum class EForcedWavePriority : uint8_t
    {
        PRIORITY_Lowest  = 0,
        PRIORITY_Lower   = 1,
        PRIORITY_Normal  = 2,
    ...
    // Enum Engine.ViewportRenderTarget2D.CopyState
    ...
    struct FPostProcessSettings
    {
        ...
        float MotionBlur_MaxVelocity;                                      // 0x0054(0x0004) (Edit)
        float MotionBlur_Amount;                                           // 0x0058(0x0004) (Edit)
        unsigned long MotionBlur_FullMotionBlur : 1;                       // 0x005C(0x0004) (Edit)
        float MotionBlur_CameraRotationThreshold;                          // 0x0060(0x0004) (Edit)
        float MotionBlur_CameraTranslationThreshold;                       // 0x0064(0x0004) (Edit)
        float MotionBlur_InterpolationDuration;                            // 0x0068(0x0004) (Edit)
        float Scene_Desaturation;                                          // 0x006C(0x0004) (Edit)
        struct FVector Scene_Colorize;                                     // 0x0070(0x000C) (Edit)
        float Scene_TonemapperScale;                                       // 0x007C(0x0004) (Edit)
        float Scene_ImageGrainScale;                                       // 0x0080(0x0004) (Edit)
        struct FVector Scene_HighLights;                                   // 0x0084(0x000C) (Edit)
        struct FVector Scene_MidTones;                                     // 0x0090(0x000C) (Edit)
        struct FVector Scene_Shadows;                                      // 0x009C(0x000C) (Edit)
        ...
        struct FMobileColorGradingParams MobileColorGrading;               // 0x00E0(0x003C) (Edit)
        struct FMobilePostProcessSettings MobilePostProcess;               // 0x011C(0x0034) (Edit)
    };
    ...
    struct FUniqueNetId
    {
        struct FGuid Uid; // 0x0000(0x0010)
    };
    ...
    {
        class USoundCue* SoundCue;     // 0x0000(0x0004) (Edit)
        float PitchScale;              // 0x0004(0x0004) (Edit)
        float VolumeScale;             // 0x0008(0x0004) (Edit)
        int StartPoint;                // 0x000C(0x0004) (Edit)
        int EndPoint;                  // 0x0010(0x0004) (Edit)
        struct FDouble LastUpdateTime; // 0x0014(0x0008) (Const, Native)
        float SourceInteriorVolume;    // 0x001C(0x0004) (Const, Native)
        float SourceInteriorLPF;       // 0x0020(0x0004) (Const, Native)
        float CurrentInteriorVolume;   // 0x0024(0x0004) (Const, Native)
        float CurrentInteriorLPF;      // 0x0028(0x0004) (Const, Native)
    ...
    struct FSplineSoundSlot
    {
        ...
        int StartPoint;                // 0x000C(0x0004) (Edit)
        int EndPoint;                  // 0x0010(0x0004) (Edit)
        float Weight;                  // 0x0014(0x0004) (Edit)
    ...
    // ScriptStruct Engine.ProximityDetectorComponent.MultiTouchInfo
    // 0x0070
    struct FMultiTouchInfo
    {
        struct FMatrix Transform;       // 0x0000(0x0040)
        struct FBoxSphereBounds Bounds; // 0x0040(0x001C)
        TArray<class AActor*> Touching; // 0x005C(0x000C) (NeedCtorLink)
        unsigned long bIsUsed : 1;      // 0x0068(0x0004)
        int PhysXIndex;                 // 0x006C(0x0004)
    };

    // ScriptStruct Engine.ProximityDetectorComponent.DeferredTouchInfo
    // 0x000C
    struct FDeferredTouchInfo
    {
        class AActor* TouchActor; // 0x0000(0x0004)
        int Index;                // 0x0004(0x0004)
        unsigned long bTouch : 1; // 0x0008(0x0004)
    };
    ...
    struct FPlatformInterfaceData
    {
        ...
        struct FString StringValue;                   // 0x0014(0x000C) (AlwaysInit, NeedCtorLink)
        struct FString StringValue2;                  // 0x0020(0x000C) (AlwaysInit, NeedCtorLink)
    ...
    struct FPlatformInterfaceDelegateResult
    {
        ...
        struct FPlatformInterfaceData Data; // 0x0004(0x0030) (NeedCtorLink)
    };
    ...
    {
        TArray<struct FScriptDelegate> Delegates; // 0x0000(0x000C) (NeedCtorLink)
    };
    ...
    struct FNotificationInfo
    {
        ...
        struct FString MessageBody;                          // 0x0004(0x000C) (NeedCtorLink)
        int BadgeNumber;                                     // 0x0010(0x0004)
        TArray<struct FNotificationMessageInfo> MessageInfo; // 0x0014(0x000C) (NeedCtorLink)
    };
    ...
    struct FLaunchNotificationInfo
    {
        ...
        struct FNotificationInfo Notification;         // 0x0004(0x0020) (NeedCtorLink)
    };
    ...
    struct FGameSessionInformation
    {
        ...
        struct FUniqueNetId OwningNetId;              // 0x0064(0x0010) (Const)
        int PlaylistId;                               // 0x0074(0x0004)
    };
    ...
    struct FPlayerInformation
    {
        ...
        struct FUniqueNetId UniqueId; // 0x0014(0x0010)
        unsigned long bIsBot : 1;     // 0x0024(0x0004)
    };
    ...
    // ScriptStruct Engine.GameplayEvents.ItemClassEventData
    // 0x0008
    struct FItemClassEventData
    {
        struct FName ItemClassName; // 0x0000(0x0008)
    };
    ...
    struct FIniLocFileEntry
    {
        ...
        struct FString DLName;                              // 0x000C(0x000C) (NeedCtorLink)
        struct FString HashCode;                            // 0x0018(0x000C) (NeedCtorLink)
    ...
    // ScriptStruct Engine.OnlineSubsystem.ChatMessage
    // 0x001C
    struct FChatMessage
    {
        struct FString MessageId;    // 0x0000(0x000C) (Const, NeedCtorLink)
        struct FString Message;      // 0x000C(0x000C) (Const, NeedCtorLink)
        unsigned long bOutgoing : 1; // 0x0018(0x0004) (Const)
        unsigned long bUnread : 1;   // 0x0018(0x0004)
    };
    ...
    struct FOnlineFriend
    {
        ...
        TArray<struct FChatMessage> ChatMessages;    // 0x0010(0x000C) (NeedCtorLink)
        unsigned long bChatSessionOpen : 1;          // 0x001C(0x0004)
        struct FQWord SessionId;                     // 0x0020(0x0008) (Const)
        struct FString NickName;                     // 0x0028(0x000C) (Const, NeedCtorLink)
        struct FString PresenceInfo;                 // 0x0034(0x000C) (Const, NeedCtorLink)
        ...
        class UOnlineClanInfo* Clan;                 // 0x0048(0x0004)
        unsigned long bIsOnlineGameClient : 1;       // 0x004C(0x0004)
        unsigned long bIsOnlineWebClient : 1;        // 0x004C(0x0004)
    };
    ...
    struct FRecentParty
    {
        ...
        TArray<struct FUniqueNetId> PartyMembers; // 0x0010(0x000C) (NeedCtorLink)
    };
    ...
    struct FOnlineStatsRow
    {
        ...
        struct FSettingsData Rank;                 // 0x0010(0x000C) (Const)
        struct FString NickName;                   // 0x001C(0x000C) (Const, NeedCtorLink)
        TArray<struct FOnlineStatsColumn> Columns; // 0x0028(0x000C) (NeedCtorLink)
    };
    ...
    {
        struct FString Identifier;         // 0x0000(0x000C) (NeedCtorLink)
        struct FString DisplayName;        // 0x000C(0x000C) (NeedCtorLink)
        struct FString DisplayDescription; // 0x0018(0x000C) (NeedCtorLink)
        struct FString DisplayPrice;       // 0x0024(0x000C) (NeedCtorLink)
        struct FString CurrencyType;       // 0x0030(0x000C) (NeedCtorLink)
    };
    ...
    {
        struct FPostProcessSettings LastSettings; // 0x0000(0x0150) (NeedCtorLink)
    ...
    {
        struct FPostProcessSettings Settings;    // 0x0000(0x0150) (NeedCtorLink)
        ...
        struct FInterpCurveFloat TimeAlphaCurve; // 0x0168(0x0010) (NeedCtorLink)
    };

    // ScriptStruct Engine.R_TestHarness.TestCondition
    // 0x001C
    struct FTestCondition
    {
        struct FName Name;          // 0x0000(0x0008)
        unsigned long bEnabled : 1; // 0x0008(0x0004)
        int NumChecksToActive;      // 0x000C(0x0004)
        float TimeToActive;         // 0x0010(0x0004)
        int NumChecks;              // 0x0014(0x0004)
        float TimeEnabled;          // 0x0018(0x0004)
    };
    ...
    struct FStaticMeshComponentLODInfo
    {
        ...
        TArray<struct FPaintedVertex> PaintedVertices; // 0x0020(0x000C) (Const, NeedCtorLink)
    };
    ...
    struct FPathStore
    {
        TArray<struct FEdgePointer> EdgeList; // 0x0000(0x000C) (Native)
    };
    ...
    struct FMaterialInput
    {
        ...
        struct FString InputName;              // 0x0008(0x000C) (NeedCtorLink)
    ...
    struct AFracturedStaticMeshActor_FCheckpointRecord
    {
        ...
        TArray<unsigned char> FragmentVis; // 0x0004(0x000C) (NeedCtorLink)
    };
    ...
    {
        TArray<int> LODMaterialMap; // 0x0000(0x000C) (Edit, Const, EditFixedSize, AlwaysInit, NeedCtorLink)
    };
    ...
    struct FNxDestructibleParameters
    {
        ...
        TArray<struct FNxDestructibleDepthParameters> DepthParameters;        // 0x00D0(0x000C) (Edit, EditFixedSize, NeedCtorLink)
        int DynamicChunksDominanceGroup;                                      // 0x00DC(0x0004) (Edit)
        unsigned long UseDynamicChunksGroupsMask : 1;                         // 0x00E0(0x0004) (Edit)
        TEnumAsByte<ERBCollisionChannel> DynamicChunksChannel;                // 0x00E4(0x0001) (Edit, Const)
        unsigned char UnknownData00[0x3];                                     // 0x00E5(0x0003) MISSED OFFSET
        struct FRBCollisionChannelContainer DynamicChunksCollideWithChannels; // 0x00E8(0x0004) (Edit, Const)
    };
    ...
    {
        class UClass* PawnClass;                 // 0x0000(0x0004) (Edit)
        TArray<class UAnimSet*> PreviewAnimSets; // 0x0004(0x000C) (Edit, NeedCtorLink)
        struct FName AnimSeqName;                // 0x0010(0x0008) (Edit)
        struct FVector Location;                 // 0x0018(0x000C) (EditConst)
        struct FRotator Rotation;                // 0x0024(0x000C) (EditConst)
        class APawn* PawnInst;                   // 0x0030(0x0004) (Transient)
    };
    ...
    struct FMaterialReferenceList
    {
        ...
        TArray<struct FPrimitiveMaterialRef> AffectedMaterialRefs;          // 0x0004(0x000C) (Component, NeedCtorLink)
        TArray<struct FPostProcessMaterialRef> AffectedPPChainMaterialRefs; // 0x0010(0x000C) (NeedCtorLink)
    };
    ...
    {
        struct FString OutputName; // 0x0000(0x000C) (NeedCtorLink)
    ...
    struct FCustomInput
    {
        ...
        struct FExpressionInput Input; // 0x000C(0x002C) (NeedCtorLink)
    };
    ...
    struct FLayerBlendInput
    {
        ...
        unsigned char UnknownData00[0x3];                // 0x0009(0x0003) MISSED OFFSET
        struct FExpressionInput LayerInput;              // 0x000C(0x002C) (NeedCtorLink)
        struct FExpressionInput HeightInput;             // 0x0038(0x002C) (NeedCtorLink)
        float PreviewWeight;                             // 0x0064(0x0004) (Edit)
        struct FPointer InstanceOverride;                // 0x0068(0x0004) (Const, Native, Transient)
    };
    ...
    {
        class UMaterialExpressionFunctionInput* ExpressionInput; // 0x0000(0x0004) (Transient)
        struct FGuid ExpressionInputId;                          // 0x0004(0x0010)
        struct FExpressionInput Input;                           // 0x0014(0x002C) (NeedCtorLink)
    };
    ...
    {
        class UMaterialExpressionFunctionOutput* ExpressionOutput; // 0x0000(0x0004) (Transient)
        struct FGuid ExpressionOutputId;                           // 0x0004(0x0010)
        struct FExpressionOutput Output;                           // 0x0014(0x0020) (NeedCtorLink)
    };
    ...
    {
        struct FLinearColor ParameterValue;                 // 0x0030(0x0010) (Edit)
        struct FInterpCurveLinearColor ParameterValueCurve; // 0x0040(0x0010) (Edit, NeedCtorLink)
    };
    ...
    struct FParticleAttractorCollisionAction
    {
        ...
        unsigned char UnknownData00[0x3];               // 0x0001(0x0003) MISSED OFFSET
        struct FString EventName;                       // 0x0004(0x000C) (Edit, NeedCtorLink)
    };
    ...
    {
        class UApexGenericAsset* IOFXAsset;    // 0x0000(0x0004) (Edit)
        class UApexGenericAsset* EmitterAsset; // 0x0004(0x0004) (Edit)
    };
    ...
    struct FSeqOpOutputLink
    {
        ...
        unsigned long bClampedMin : 1;              // 0x0028(0x0004)
        int OverrideDelta;                          // 0x002C(0x0004)
        float PIEActivationTime;                    // 0x0030(0x0004) (Transient)
    ...
    struct FAnimSetBakeAndPruneStatus
    {
        ...
        unsigned long bSkipCooking : 1;         // 0x000C(0x0004) (Edit)
    };
    ...
    struct FLandscapeLayerStruct
    {
        ...
        int DebugColorChannel;                         // 0x000C(0x0004) (Transient)
        unsigned long bSelected : 1;                   // 0x0010(0x0004) (Transient)
        struct FString SourceFilePath;                 // 0x0014(0x000C) (NeedCtorLink)
    };
    ...
    struct FLandscapeLayerInfo
    {
        ...
        class UPhysicalMaterial* PhysMaterial;         // 0x0010(0x0004) (Edit)
        class UMaterialInstanceConstant* ThumbnailMIC; // 0x0014(0x0004)
        unsigned long bSelected : 1;                   // 0x0018(0x0004) (Transient)
        int DebugColorChannel;                         // 0x001C(0x0004) (Transient)
        struct FString LayerSourceFile;                // 0x0020(0x000C) (Transient, NeedCtorLink)
    };
    ...
    struct FOnlineFriendMessage
    {
        ...
        struct FString SendingPlayerNick;    // 0x0010(0x000C) (NeedCtorLink)
        unsigned long bIsFriendInvite : 1;   // 0x001C(0x0004)
        unsigned long bIsGameInvite : 1;     // 0x001C(0x0004)
        unsigned long bWasAccepted : 1;      // 0x001C(0x0004)
        unsigned long bWasDenied : 1;        // 0x001C(0x0004)
    ...
    struct FOnlinePartyMember
    {
        ...
        unsigned char LocalUserNum;           // 0x001C(0x0001) (Const)
        TEnumAsByte<ENATType> NatType;        // 0x001D(0x0001) (Const)
        unsigned char UnknownData00[0x2];     // 0x001E(0x0002) MISSED OFFSET
        int TitleId;                          // 0x0020(0x0004) (Const)
        unsigned long bIsLocal : 1;           // 0x0024(0x0004) (Const)
        unsigned long bIsInPartyVoice : 1;    // 0x0024(0x0004) (Const)
        unsigned long bIsTalking : 1;         // 0x0024(0x0004) (Const)
        unsigned long bIsInGameSession : 1;   // 0x0024(0x0004) (Const)
        unsigned long bIsPlayingThisGame : 1; // 0x0024(0x0004) (Const)
        struct FQWord SessionId;              // 0x0028(0x0008) (Const)
        int Data1;                            // 0x0030(0x0004) (Const)
        int Data2;                            // 0x0034(0x0004) (Const)
        int Data3;                            // 0x0038(0x0004) (Const)
        int Data4;                            // 0x003C(0x0004) (Const)
    };
    ...
    struct FListener
    {
        ...
        int ViewportIndex;                 // 0x0040(0x0004) (Const, Transient)
        float AttenuationMultiplier;       // 0x0044(0x0004) (Transient)
    };
    ...
    {
        TArray<int> ClothingSectionInfo; // 0x0000(0x000C) (Edit, EditFixedSize, NeedCtorLink)
    };
    ...
    {
        TArray<struct FApexClothingLodInfo> ClothingLodInfo; // 0x0000(0x000C) (Edit, EditFixedSize, NeedCtorLink)
    ...
    {
        struct FString ParamName;  // 0x0000(0x000C) (NeedCtorLink)
        struct FString ParamValue; // 0x000C(0x000C) (NeedCtorLink)
    };
    ...
    struct FFacebookFriend
    {
        ...
        struct FString Id;   // 0x000C(0x000C) (NeedCtorLink)
    };
    ...
    struct FEmsFile
    {
        struct FString Hash;     // 0x0000(0x000C) (NeedCtorLink)
        struct FString DLName;   // 0x000C(0x000C) (NeedCtorLink)
    ...
    struct FSocialPostImageInfo
    {
        ...
        struct FString MessageText;         // 0x0004(0x000C) (NeedCtorLink)
        struct FString TitleText;           // 0x0010(0x000C) (NeedCtorLink)
        struct FString PictureCaption;      // 0x001C(0x000C) (NeedCtorLink)
        struct FString PictureDescription;  // 0x0028(0x000C) (NeedCtorLink)
    };
    ...
    {
        struct FString TitleURL;   // 0x0034(0x000C) (NeedCtorLink)
        struct FString PictureURL; // 0x0040(0x000C) (NeedCtorLink)
    };
    ...
    struct FCommunityContentFile
    {
        ...
        struct FString LocalFilePath; // 0x0030(0x000C) (NeedCtorLink)
    };
    ...
    struct FPendingClientAuth
    {
        ...
        struct FUniqueNetId ClientUID;   // 0x0004(0x0010)
        float AuthTimestamp;             // 0x0014(0x0004)
    ...
    // ScriptStruct Engine.ApexGenericAsset.GroupMask64Bit
    // 0x0008
    struct FGroupMask64Bit
    {
        int bits0; // 0x0000(0x0004) (AlwaysInit)
        int bits1; // 0x0004(0x0004) (AlwaysInit)
    };
