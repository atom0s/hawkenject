...
{
	struct FString                                     StringData;                                               // 0x001C(0x000C) (NeedCtorLink)
...
{
	struct FString                                     LogicalName;                                              // 0x001C(0x000C) (NeedCtorLink)
	struct FString                                     Hash;                                                     // 0x0028(0x000C) (NeedCtorLink)
	TEnumAsByte<ETitleFileFileOp>                      FileOp;                                                   // 0x0034(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0035(0x0003) MISSED OFFSET
	struct FPointer                                    Ar;                                                       // 0x0038(0x0004) (Const, Native)
};
...
struct FMcpMessage
{
	struct FString                                     MessageId;                                                // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     ToUniqueUserId;                                           // 0x000C(0x000C) (NeedCtorLink)
	struct FString                                     FromUniqueUserId;                                         // 0x0018(0x000C) (NeedCtorLink)
	struct FString                                     FromFriendlyName;                                         // 0x0024(0x000C) (NeedCtorLink)
	struct FString                                     MessageType;                                              // 0x0030(0x000C) (NeedCtorLink)
	struct FString                                     ValidUntil;                                               // 0x003C(0x000C) (NeedCtorLink)
...
{
	struct FString                                     ToUniqueUserId;                                           // 0x0000(0x000C) (NeedCtorLink)
	TArray<struct FMcpMessage>                         Messages;                                                 // 0x000C(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     MessageId;                                                // 0x0000(0x000C) (NeedCtorLink)
	TArray<unsigned char>                              MessageContents;                                          // 0x000C(0x000C) (NeedCtorLink)
};
...
{
	TArray<unsigned char>                              SourceBuffer;                                             // 0x0000(0x000C) (NeedCtorLink)
	TArray<unsigned char>                              DestBuffer;                                               // 0x000C(0x000C) (NeedCtorLink)
	int                                                OutCompressedSize;                                        // 0x0018(0x0004)
	class UHttpRequestInterface*                       Request;                                                  // 0x001C(0x0004)
	struct FPointer                                    CompressionWorker;                                        // 0x0020(0x0004) (Native)
};
...
{
	struct FString                                     MessageId;                                                // 0x0000(0x000C) (NeedCtorLink)
	TArray<unsigned char>                              SourceBuffer;                                             // 0x000C(0x000C) (NeedCtorLink)
	TArray<unsigned char>                              DestBuffer;                                               // 0x0018(0x000C) (NeedCtorLink)
	int                                                OutUncompressedSize;                                      // 0x0024(0x0004)
	struct FPointer                                    UncompressionWorker;                                      // 0x0028(0x0004) (Native)
};
...
{
	struct FString                                     CreationDate;                                             // 0x0028(0x000C) (NeedCtorLink)
	struct FString                                     LastUpdateDate;                                           // 0x0034(0x000C) (NeedCtorLink)
	struct FString                                     CompressionType;                                          // 0x0040(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     UserId;                                                   // 0x0000(0x000C) (NeedCtorLink)
	TArray<struct FTitleFileWeb>                       DownloadedFiles;                                          // 0x000C(0x000C) (NeedCtorLink)
	TArray<struct FMcpUserCloudFileInfo>               EnumeratedFiles;                                          // 0x0018(0x000C) (NeedCtorLink)
...
struct FClientConnectionRequest
{
	...
	TArray<struct FConnectionBandwidthStats>           BandwidthHistory;                                         // 0x001C(0x000C) (NeedCtorLink)
	int                                                MinutesSinceLastTest;                                     // 0x0028(0x0004)
};
...
struct FClientMeshBeaconConnection
{
	...
	struct FPointer                                    Socket;                                                   // 0x0014(0x0004) (Native, Transient)
	unsigned long                                      bConnectionAccepted : 1;                                  // 0x0018(0x0004)
	struct FClientConnectionBandwidthTestData          BandwidthTest;                                            // 0x001C(0x0028)
	TEnumAsByte<ENATType>                              NatType;                                                  // 0x0044(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0045(0x0003) MISSED OFFSET
	unsigned long                                      bCanHostVs : 1;                                           // 0x0048(0x0004)
	float                                              GoodHostRatio;                                            // 0x004C(0x0004)
	TArray<struct FConnectionBandwidthStats>           BandwidthHistory;                                         // 0x0050(0x000C) (NeedCtorLink)
...
struct FPartyReservation
{
	...
	TArray<struct FPlayerReservation>                  PartyMembers;                                             // 0x0014(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     unique_challenge_id;                                      // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     unique_user_id;                                           // 0x000C(0x000C) (NeedCtorLink)
	...
	struct FString                                     last_update_time;                                         // 0x0028(0x000C) (NeedCtorLink)
	int                                                user_award_given;                                         // 0x0034(0x0004)
	struct FString                                     accept_time;                                              // 0x0038(0x000C) (NeedCtorLink)
	unsigned long                                      did_preregister : 1;                                      // 0x0044(0x0004)
	struct FString                                     facebook_like_time;                                       // 0x0048(0x000C) (NeedCtorLink)
	...
	struct FString                                     twitter_retweet_time;                                     // 0x0058(0x000C) (NeedCtorLink)
...
struct FMcpClashMobChallengeFile
{
	...
	struct FString                                     title_id;                                                 // 0x0004(0x000C) (NeedCtorLink)
	struct FString                                     file_name;                                                // 0x0010(0x000C) (NeedCtorLink)
	struct FString                                     dl_name;                                                  // 0x001C(0x000C) (NeedCtorLink)
	struct FString                                     hash_code;                                                // 0x0028(0x000C) (NeedCtorLink)
	struct FString                                     Type;                                                     // 0x0034(0x000C) (NeedCtorLink)
...
{
	struct FString                                     unique_challenge_id;                                      // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     visible_date;                                             // 0x000C(0x000C) (NeedCtorLink)
	struct FString                                     start_date;                                               // 0x0018(0x000C) (NeedCtorLink)
	struct FString                                     end_date;                                                 // 0x0024(0x000C) (NeedCtorLink)
	struct FString                                     completed_date;                                           // 0x0030(0x000C) (NeedCtorLink)
	struct FString                                     purge_date;                                               // 0x003C(0x000C) (NeedCtorLink)
	struct FString                                     challenge_type;                                           // 0x0048(0x000C) (NeedCtorLink)
	...
	TArray<struct FMcpClashMobChallengeFile>           file_list;                                                // 0x006C(0x000C) (NeedCtorLink)
...
{
	TArray<struct FString>                             device_tokens;                                            // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     badge_type;                                               // 0x000C(0x000C) (NeedCtorLink)
	struct FString                                     Sound;                                                    // 0x0018(0x000C) (NeedCtorLink)
	struct FString                                     Message;                                                  // 0x0024(0x000C) (NeedCtorLink)
...
{
	struct FString                                     UniqueChallengeId;                                        // 0x0000(0x000C) (NeedCtorLink)
...
{
	struct FString                                     UniqueUserId;                                             // 0x0000(0x000C) (NeedCtorLink)
	TArray<struct FMcpChallengeRequest>                ChallengeStatusRequests;                                  // 0x000C(0x000C) (NeedCtorLink)
	TArray<struct FMcpChallengeRequest>                ChallengeAcceptRequests;                                  // 0x0018(0x000C) (NeedCtorLink)
	TArray<struct FMcpChallengeRequest>                ChallengeUpdateProgressRequests;                          // 0x0024(0x000C) (NeedCtorLink)
	TArray<struct FMcpChallengeRequest>                ChallengeUpdateRewardRequests;                            // 0x0030(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     MemberId;                                                 // 0x0000(0x000C) (NeedCtorLink)
...
struct FMcpGroup
{
	struct FString                                     OwnerId;                                                  // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     GroupID;                                                  // 0x000C(0x000C) (NeedCtorLink)
	struct FString                                     GroupName;                                                // 0x0018(0x000C) (NeedCtorLink)
	TEnumAsByte<EMcpGroupAccessLevel>                  AccessLevel;                                              // 0x0024(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
	TArray<struct FMcpGroupMember>                     Members;                                                  // 0x0028(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     RequesterId;                                              // 0x0000(0x000C) (NeedCtorLink)
	TArray<struct FMcpGroup>                           Groups;                                                   // 0x000C(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     McpId;                                                    // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     ExternalId;                                               // 0x000C(0x000C) (NeedCtorLink)
	struct FString                                     ExternalType;                                             // 0x0018(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     ExternalType;                                             // 0x0000(0x000C) (NeedCtorLink)
...
{
	struct FString                                     OwningMcpId;                                              // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     SaveSlot;                                                 // 0x000C(0x000C) (NeedCtorLink)
	TArray<struct FManagedValue>                       Values;                                                   // 0x0018(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     GlobalItemId;                                             // 0x0000(0x000C) (NeedCtorLink)
...
{
	struct FString                                     AttributeId;                                              // 0x0000(0x000C) (NeedCtorLink)
...
{
	struct FString                                     InstanceItemId;                                           // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     GlobalItemId;                                             // 0x000C(0x000C) (NeedCtorLink)
	int                                                Quantity;                                                 // 0x0018(0x0004)
	int                                                QuantityIAP;                                              // 0x001C(0x0004)
	float                                              Scalar;                                                   // 0x0020(0x0004)
	struct FString                                     LastUpdateTime;                                           // 0x0024(0x000C) (NeedCtorLink)
	TArray<struct FMcpInventoryItemAttribute>          Attributes;                                               // 0x0030(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     OwningMcpId;                                              // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     SaveSlotId;                                               // 0x000C(0x000C) (NeedCtorLink)
	TArray<struct FMcpInventoryItem>                   Items;                                                    // 0x0018(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     ItemId;                                                   // 0x001C(0x000C) (NeedCtorLink)
};
...
{
	struct FString                                     McpId;                                                    // 0x0000(0x000C) (NeedCtorLink)
	struct FString                                     SecretKey;                                                // 0x000C(0x000C) (NeedCtorLink)
	struct FString                                     Ticket;                                                   // 0x0018(0x000C) (NeedCtorLink)
	struct FString                                     UDID;                                                     // 0x0024(0x000C) (NeedCtorLink)
	struct FString                                     RegisteredDate;                                           // 0x0030(0x000C) (NeedCtorLink)
	struct FString                                     LastActiveDate;                                           // 0x003C(0x000C) (NeedCtorLink)
...
{
	struct FString                                     URL;                                                      // 0x0000(0x000C) (NeedCtorLink)
	class UHttpRequestInterface*                       HTTPRequest;                                              // 0x000C(0x0004)
