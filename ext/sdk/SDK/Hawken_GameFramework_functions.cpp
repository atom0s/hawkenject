...
void AGameCrowdAgent::TakeDamage(float DamageAmount, class AController* EventInstigator, const struct FVector& HitLocation, const struct FVector& Momentum, class UClass* DamageType, const struct FTraceHitInfo& HitInfo, class AActor* DamageCauser)
{
...
void UGameCameraBase::OnBecomeInActive(class APawn* P, class UGameCameraBase* NewCamera)
{
...
void UGameCameraBase::OnBecomeActive(class APawn* P, class UGameCameraBase* OldCamera)
{
...
void UGameThirdPersonCamera::OnBecomeActive(class APawn* P, class UGameCameraBase* OldCamera)
{
...
void UGameFixedCamera::OnBecomeActive(class APawn* P, class UGameCameraBase* OldCamera)
{
