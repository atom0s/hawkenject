...
#define CONST_LOADING_MOVIE                                      "Splash_loading"
...
#define CONST_GAMEEVENT_AGGREGATED_ITEM_USED                     10500
...
{
	class AActor*                                      Dynamic;                                                  // 0x0000(0x0004) (Edit)
};
...
struct FCrowdSpawnInfoItem
{
	...
	TArray<class AGameCrowdAgent*>                     ActiveAgents;                                             // 0x0014(0x000C) (NeedCtorLink)
	TArray<struct FAgentArchetypeInfo>                 AgentArchetypes;                                          // 0x0020(0x000C) (NeedCtorLink)
	...
	int                                                NumAgentsToTickPerFrame;                                  // 0x004C(0x0004) (Edit)
	int                                                LastAgentTickedIndex;                                     // 0x0050(0x0004)
	TArray<class AGameCrowdDestination*>               PotentialSpawnPoints;                                     // 0x0054(0x000C) (NeedCtorLink)
	...
	TArray<class AGameCrowdDestination*>               PrioritizedSpawnPoints;                                   // 0x006C(0x000C) (NeedCtorLink)
...
// ScriptStruct GameFramework.GameStatsAggregator.ItemEvents
// 0x0000 (0x0048 - 0x0048)
struct FItemEvents : public FEventsBase
{
...
struct FTeamEvents
{
	...
	struct FItemEvents                                 ItemEvents;                                               // 0x01A4(0x0048) (NeedCtorLink)
};
...
struct FShakeParams
{
	unsigned char                                      Padding;                                                  // 0x0000(0x0001) (Const, Transient)
	TEnumAsByte<EShakeParam>                           X;                                                        // 0x0001(0x0001)
	TEnumAsByte<EShakeParam>                           Y;                                                        // 0x0002(0x0001)
	TEnumAsByte<EShakeParam>                           Z;                                                        // 0x0003(0x0001)
};
