...
{
public:
	struct FInterpCurveFloat                           AnimatedScale;                                            // 0x01FC(0x0010) (Edit, NeedCtorLink)
	struct FInterpCurveLinearColor                     AnimatedColor;                                            // 0x020C(0x0010) (Edit, NeedCtorLink)
	struct FInterpCurveVector2D                        AnimatedPosition;                                         // 0x021C(0x0010) (Edit, NeedCtorLink)
	struct FVector                                     LocationOffset;                                           // 0x022C(0x000C) (Edit)
	int                                                LoopCount;                                                // 0x0238(0x0004) (Edit)
...
{
public:
	TArray<struct FRequiredMobileInputConfig>          RequiredMobileInputConfigs;                               // 0x039C(0x000C) (Config, NeedCtorLink)
...
{
public:
	class UGameAICommand*                              CommandList;                                              // 0x0370(0x0004) (Edit, Const, Transient, EditInline)
	unsigned long                                      bHasRunawayCommandList : 1;                               // 0x0374(0x0004) (Transient)
	unsigned long                                      bAILogging : 1;                                           // 0x0374(0x0004) (Edit, Config)
	unsigned long                                      bAILogToWindow : 1;                                       // 0x0374(0x0004) (Edit, Config)
	unsigned long                                      bFlushAILogEachLine : 1;                                  // 0x0374(0x0004) (Edit, Config)
	unsigned long                                      bMapBasedLogName : 1;                                     // 0x0374(0x0004) (Edit, Config)
	unsigned long                                      bAIDrawDebug : 1;                                         // 0x0374(0x0004) (Edit, Config)
	unsigned long                                      bAIBroken : 1;                                            // 0x0374(0x0004) (Transient)
	class AFileLog*                                    AILogFile;                                                // 0x0378(0x0004) (Transient)
	float                                              DebugTextMaxLen;                                          // 0x037C(0x0004) (Edit)
	TArray<struct FAICmdHistoryItem>                   CommandHistory;                                           // 0x0380(0x000C) (Edit, Const, Transient, NeedCtorLink)
	int                                                CommandHistoryNum;                                        // 0x038C(0x0004) (Edit, Config)
	TArray<struct FName>                               AILogFilter;                                              // 0x0390(0x000C) (Edit, Config, NeedCtorLink)
	struct FString                                     DemoActionString;                                         // 0x039C(0x000C) (Net, NeedCtorLink)
...
{
public:
	unsigned long                                      bWarnCrowdMembers : 1;                                    // 0x0608(0x0004)
	unsigned long                                      bDebugCrowdAwareness : 1;                                 // 0x0608(0x0004) (Edit)
	unsigned long                                      bIsWarmupPaused : 1;                                      // 0x0608(0x0004) (Transient)
	float                                              AgentAwareRadius;                                         // 0x060C(0x0004)
	struct FName                                       CurrentSoundMode;                                         // 0x0610(0x0008) (Transient)
...
public:
	...
	struct FString                                     DebugCameraControllerClassName;                           // 0x005C(0x000C) (Config, NeedCtorLink)
...
{
public:
	struct FPointer                                    VfTable_IInterface_RVO;                                   // 0x01D8(0x0004) (Const, Native, NoExport)
	class UGameCrowdGroup*                             MyGroup;                                                  // 0x01DC(0x0004)
	struct FVector                                     PreferredVelocity;                                        // 0x01E0(0x000C)
	struct FVector                                     PendingVelocity;                                          // 0x01EC(0x000C)
	class AGameCrowdDestination*                       CurrentDestination;                                       // 0x01F8(0x0004)
	class AGameCrowdDestination*                       BehaviorDestination;                                      // 0x01FC(0x0004)
	class AGameCrowdDestination*                       PreviousDestination;                                      // 0x0200(0x0004)
	...
	TArray<struct FNearbyDynamicItem>                  NearbyDynamics;                                           // 0x0218(0x000C) (Transient, NeedCtorLink)
	unsigned long                                      bUniformScale : 1;                                        // 0x0224(0x0004)
	unsigned long                                      bCheckForObstacles : 1;                                   // 0x0224(0x0004) (Edit)
	unsigned long                                      bUseNavMeshPathing : 1;                                   // 0x0224(0x0004) (Edit)
	unsigned long                                      bWantsSeePlayerNotification : 1;                          // 0x0224(0x0004)
	unsigned long                                      bAllowPitching : 1;                                       // 0x0224(0x0004) (Edit)
	unsigned long                                      bHitObstacle : 1;                                         // 0x0224(0x0004)
	unsigned long                                      bBadHitNormal : 1;                                        // 0x0224(0x0004)
	unsigned long                                      bSimulateThisTick : 1;                                    // 0x0224(0x0004)
	unsigned long                                      bPotentialEncounter : 1;                                  // 0x0224(0x0004)
	unsigned long                                      bIsPanicked : 1;                                          // 0x0224(0x0004)
	unsigned long                                      bWantsGroupIdle : 1;                                      // 0x0224(0x0004)
	unsigned long                                      bPreferVisibleDestination : 1;                            // 0x0224(0x0004) (Edit)
	unsigned long                                      bPreferVisibleDestinationOnSpawn : 1;                     // 0x0224(0x0004) (Edit)
	unsigned long                                      bHasNotifiedSpawner : 1;                                  // 0x0224(0x0004)
	unsigned long                                      bIsInSpawnPool : 1;                                       // 0x0224(0x0004)
	unsigned long                                      bPaused : 1;                                              // 0x0224(0x0004) (Edit)
	TEnumAsByte<EConformType>                          ConformType;                                              // 0x0228(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0229(0x0003) MISSED OFFSET
	float                                              ConformTraceDist;                                         // 0x022C(0x0004) (Edit)
	int                                                ConformTraceInterval;                                     // 0x0230(0x0004) (Edit)
	int                                                CurrentConformTraceInterval;                              // 0x0234(0x0004)
	float                                              LastGroundZ;                                              // 0x0238(0x0004)
	float                                              AwareRadius;                                              // 0x023C(0x0004) (Edit)
	float                                              AvoidOtherRadius;                                         // 0x0240(0x0004) (Edit)
	TArray<struct FAvoidOtherSampleItem>               AvoidOtherSampleList;                                     // 0x0244(0x000C) (Edit, NeedCtorLink)
	float                                              PENALTY_COEFF_ANGLETOGOAL;                                // 0x0250(0x0004) (Edit)
	float                                              PENALTY_COEFF_ANGLETOVEL;                                 // 0x0254(0x0004) (Edit)
	float                                              PENALTY_COEFF_MAG;                                        // 0x0258(0x0004) (Edit)
	float                                              MIN_PENALTY_THRESHOLD;                                    // 0x025C(0x0004) (Edit)
	float                                              LastProgressTime;                                         // 0x0260(0x0004) (Edit)
	float                                              LastFallbackActiveTime;                                   // 0x0264(0x0004) (Edit)
	float                                              MaxPathLaneValue;                                         // 0x0268(0x0004) (Edit)
	float                                              CurrentPathLaneValue;                                     // 0x026C(0x0004) (Edit)
	int                                                ExtraPathCost;                                            // 0x0270(0x0004) (Edit)
	float                                              RotateToTargetSpeed;                                      // 0x0274(0x0004) (Edit)
	float                                              MaxYawRate;                                               // 0x0278(0x0004) (Edit)
	struct FVector                                     MeshMinScale3D;                                           // 0x027C(0x000C) (Edit)
	struct FVector                                     MeshMaxScale3D;                                           // 0x0288(0x000C) (Edit)
	float                                              EyeZOffset;                                               // 0x0294(0x0004)
	float                                              ProximityLODDist;                                         // 0x0298(0x0004) (Edit)
	float                                              VisibleProximityLODDist;                                  // 0x029C(0x0004) (Edit)
	struct FVector                                     LastKnownGoodPosition;                                    // 0x02A0(0x000C)
	float                                              GroundOffset;                                             // 0x02AC(0x0004) (Edit)
	struct FVector                                     IntermediatePoint;                                        // 0x02B0(0x000C)
	struct FVector                                     SearchExtent;                                             // 0x02BC(0x000C)
	class UClass*                                      NavigationHandleClass;                                    // 0x02C8(0x0004)
	class UNavigationHandle*                           NavigationHandle;                                         // 0x02CC(0x0004)
	int                                                ObstacleCheckCount;                                       // 0x02D0(0x0004)
	float                                              WalkableFloorZ;                                           // 0x02D4(0x0004)
	float                                              LastPathingAttempt;                                       // 0x02D8(0x0004)
	float                                              LastUpdateTime;                                           // 0x02DC(0x0004)
	float                                              NotVisibleLifeSpan;                                       // 0x02E0(0x0004) (Edit)
	...
	float                                              CurrentBehaviorActivationTime;                            // 0x0330(0x0004)
	TArray<struct FBehaviorEntry>                      EncounterAgentBehaviors;                                  // 0x0334(0x000C) (Edit, NeedCtorLink)
	TArray<struct FBehaviorEntry>                      SeePlayerBehaviors;                                       // 0x0340(0x000C) (Edit, NeedCtorLink)
	float                                              MaxSeePlayerDistSq;                                       // 0x034C(0x0004)
	float                                              SeePlayerInterval;                                        // 0x0350(0x0004) (Edit)
	TArray<struct FBehaviorEntry>                      SpawnBehaviors;                                           // 0x0354(0x000C) (Edit, NeedCtorLink)
	TArray<struct FBehaviorEntry>                      UneasyBehaviors;                                          // 0x0360(0x000C) (Edit, NeedCtorLink)
	TArray<struct FBehaviorEntry>                      AlertBehaviors;                                           // 0x036C(0x000C) (Edit, NeedCtorLink)
	TArray<struct FBehaviorEntry>                      PanicBehaviors;                                           // 0x0378(0x000C) (Edit, NeedCtorLink)
	TArray<struct FBehaviorEntry>                      RandomBehaviors;                                          // 0x0384(0x000C) (Edit, NeedCtorLink)
	TArray<struct FBehaviorEntry>                      TakeDamageBehaviors;                                      // 0x0390(0x000C) (Edit, NeedCtorLink)
	float                                              RandomBehaviorInterval;                                   // 0x039C(0x0004) (Edit)
	float                                              ForceUpdateTime;                                          // 0x03A0(0x0004)
	float                                              ReachThreshold;                                           // 0x03A4(0x0004)
	TArray<struct FBehaviorEntry>                      GroupWaitingBehaviors;                                    // 0x03A8(0x000C) (Edit, NeedCtorLink)
	float                                              DesiredGroupRadius;                                       // 0x03B4(0x0004) (Edit)
	float                                              DesiredGroupRadiusSq;                                     // 0x03B8(0x0004)
	float                                              MaxLOSLifeDistanceSq;                                     // 0x03BC(0x0004)
	TScriptInterface<class UGameCrowdSpawnerInterface> MySpawner;                                                // 0x03C0(0x0008)
	struct FVector                                     SpawnOffset;                                              // 0x03C8(0x000C)
	float                                              InitialLastRenderTime;                                    // 0x03D4(0x0004)
	struct FColor                                      DebugAgentColor;                                          // 0x03D8(0x0004) (Edit)
	class AGameCrowdDestination*                       DebugSpawnDest;                                           // 0x03DC(0x0004) (Edit)
...
{
public:
	class USkeletalMeshComponent*                      SkeletalMeshComponent;                                    // 0x03E0(0x0004) (Edit, ExportObject, Component, EditInline)
	class UAnimNodeBlend*                              SpeedBlendNode;                                           // 0x03E4(0x0004)
	class UAnimNodeSlot*                               FullBodySlot;                                             // 0x03E8(0x0004)
	class UAnimNodeSequence*                           ActionSeqNode;                                            // 0x03EC(0x0004)
	class UAnimNodeSequence*                           WalkSeqNode;                                              // 0x03F0(0x0004)
	class UAnimNodeSequence*                           RunSeqNode;                                               // 0x03F4(0x0004)
	class UAnimTree*                                   AgentTree;                                                // 0x03F8(0x0004)
	TArray<struct FName>                               WalkAnimNames;                                            // 0x03FC(0x000C) (Edit, NeedCtorLink)
	TArray<struct FName>                               RunAnimNames;                                             // 0x0408(0x000C) (Edit, NeedCtorLink)
	TArray<struct FName>                               IdleAnimNames;                                            // 0x0414(0x000C) (Edit, NeedCtorLink)
	TArray<struct FName>                               DeathAnimNames;                                           // 0x0420(0x000C) (Edit, NeedCtorLink)
	float                                              SpeedBlendStart;                                          // 0x042C(0x0004) (Edit)
	float                                              SpeedBlendEnd;                                            // 0x0430(0x0004) (Edit)
	float                                              AnimVelRate;                                              // 0x0434(0x0004) (Edit)
	float                                              MaxSpeedBlendChangeSpeed;                                 // 0x0438(0x0004) (Edit)
	struct FName                                       MoveSyncGroupName;                                        // 0x043C(0x0008) (Edit)
	TArray<struct FGameCrowdAttachmentList>            Attachments;                                              // 0x0444(0x000C) (Edit, NeedCtorLink)
	float                                              MaxTargetAcquireTime;                                     // 0x0450(0x0004) (Edit)
	unsigned long                                      bUseRootMotionVelocity : 1;                               // 0x0454(0x0004) (Edit)
	unsigned long                                      bAllowSkeletonUpdateChangeBasedOnTickResult : 1;          // 0x0454(0x0004) (Edit)
	unsigned long                                      bTickWhenNotVisible : 1;                                  // 0x0454(0x0004) (Edit)
	unsigned long                                      bIsPlayingIdleAnimation : 1;                              // 0x0454(0x0004)
	unsigned long                                      bIsPlayingDeathAnimation : 1;                             // 0x0454(0x0004)
	unsigned long                                      bIsPlayingImportantAnimation : 1;                         // 0x0454(0x0004)
	unsigned long                                      bAnimateThisTick : 1;                                     // 0x0454(0x0004)
	float                                              NotVisibleDisableTickTime;                                // 0x0458(0x0004) (Edit)
	float                                              MaxAnimationDistance;                                     // 0x045C(0x0004) (Edit)
	float                                              MaxAnimationDistanceSq;                                   // 0x0460(0x0004)
...
{
public:
	class UStaticMeshComponent*                        Mesh;                                                     // 0x03E0(0x0004) (Edit, ExportObject, Component, EditInline)
	class UMaterialInstanceConstant*                   MeshColor;                                                // 0x03E4(0x0004) (Edit)
...
public:
	...
	TEnumAsByte<ECrowdBehaviorEvent>                   ViralBehaviorEvent;                                       // 0x003D(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x2];                                       // 0x003E(0x0002) MISSED OFFSET
	float                                              DurationOfBehavior;                                       // 0x0040(0x0004) (Edit)
	float                                              TimeUntilStopBehavior;                                    // 0x0044(0x0004)
	unsigned long                                      bIdleBehavior : 1;                                        // 0x0048(0x0004) (Edit)
	unsigned long                                      bFaceActionTargetFirst : 1;                               // 0x0048(0x0004) (Edit)
	unsigned long                                      bIsViralBehavior : 1;                                     // 0x0048(0x0004) (Edit)
	unsigned long                                      bPassOnIsViralBehaviorFlag : 1;                           // 0x0048(0x0004) (Edit)
	class AActor*                                      ActionTarget;                                             // 0x004C(0x0004)
	float                                              MaxPlayerDistance;                                        // 0x0050(0x0004) (Edit)
	float                                              ViralRadius;                                              // 0x0054(0x0004) (Edit)
	float                                              DurationBeforeBecomesViral;                               // 0x0058(0x0004) (Edit)
	float                                              TimeToBecomeViral;                                        // 0x005C(0x0004) (Transient)
	float                                              DurationOfViralBehaviorPropagation;                       // 0x0060(0x0004) (Edit)
	float                                              TimeToStopPropagatingViralBehavior;                       // 0x0064(0x0004) (Transient)
	class AGameCrowdAgent*                             MyAgent;                                                  // 0x0068(0x0004)
	struct FColor                                      DebugBehaviorColor;                                       // 0x006C(0x0004) (Edit)
...
{
public:
	TArray<struct FName>                               AnimationList;                                            // 0x0070(0x000C) (Edit, NeedCtorLink)
	float                                              BlendInTime;                                              // 0x007C(0x0004) (Edit)
	float                                              BlendOutTime;                                             // 0x0080(0x0004) (Edit)
	unsigned long                                      bUseRootMotion : 1;                                       // 0x0084(0x0004) (Edit)
	unsigned long                                      bLookAtPlayer : 1;                                        // 0x0084(0x0004) (Edit)
	unsigned long                                      bLooping : 1;                                             // 0x0084(0x0004) (Edit)
	unsigned long                                      bBlendBetweenAnims : 1;                                   // 0x0084(0x0004) (Edit)
	class AActor*                                      CustomActionTarget;                                       // 0x0088(0x0004)
	int                                                LoopIndex;                                                // 0x008C(0x0004) (Edit)
	float                                              LoopTime;                                                 // 0x0090(0x0004) (Edit)
...
{
public:
	class AActor*                                      PanicFocus;                                               // 0x0070(0x0004) (Transient)
...
{
public:
	TArray<class AGameCrowdDestination*>               PotentialSpawnPoints;                                     // 0x0200(0x000C) (Edit, NeedCtorLink)
...
{
public:
	float                                              RadiusOfBehaviorEvent;                                    // 0x01DC(0x0004) (Config)
	float                                              DurationOfBehaviorEvent;                                  // 0x01E0(0x0004) (Config)
	TEnumAsByte<ECrowdBehaviorEvent>                   EventType;                                                // 0x01E4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01E5(0x0003) MISSED OFFSET
	unsigned long                                      bRequireLOS : 1;                                          // 0x01E8(0x0004) (Edit)
	class AActor*                                      Initiator;                                                // 0x01EC(0x0004)
...
public:
	...
	unsigned long                                      bAllowCloudSpawning : 1;                                  // 0x01E0(0x0004) (Edit)
	unsigned long                                      bAllowVisibleSpawning : 1;                                // 0x01E0(0x0004) (Edit)
	...
	TArray<struct FBehaviorEntry>                      ReachedBehaviors;                                         // 0x0240(0x000C) (Edit, NeedCtorLink)
	class AGameCrowdAgent*                             AgentEnRoute;                                             // 0x024C(0x0004)
	float                                              Priority;                                                 // 0x0250(0x0004)
	float                                              LastSpawnTime;                                            // 0x0254(0x0004)
	class AGameCrowdPopulationManager*                 MyPopMgr;                                                 // 0x0258(0x0004) (Transient)
...
public:
	...
	struct FCrowdSpawnInfoItem                         CloudSpawnInfo;                                           // 0x01D8(0x007C) (NeedCtorLink)
	TArray<struct FCrowdSpawnInfoItem>                 ScriptedSpawnInfo;                                        // 0x0254(0x000C) (NeedCtorLink)
	class AGameCrowdInfoVolume*                        ActiveCrowdInfoVolume;                                    // 0x0260(0x0004)
	TArray<class AGameCrowdDestination*>               GlobalPotentialSpawnPoints;                               // 0x0264(0x000C) (NeedCtorLink)
	float                                              SplitScreenNumReduction;                                  // 0x0270(0x0004)
	float                                              PlayerPositionPredictionTime;                             // 0x0274(0x0004)
	float                                              HeadVisibilityOffset;                                     // 0x0278(0x0004)
	...
	TArray<struct FCrowdSpawnerPlayerInfo>             PlayerInfo;                                               // 0x0288(0x000C) (NeedCtorLink)
	float                                              LastPlayerInfoUpdateTime;                                 // 0x0294(0x0004)
	unsigned long                                      bDebugSpawns : 1;                                         // 0x0298(0x0004) (Edit)
	unsigned long                                      bPauseCrowd : 1;                                          // 0x0298(0x0004) (Edit)
...
{
public:
	class USeqAct_GameCrowdSpawner*                    Spawner;                                                  // 0x01D4(0x0004) (Net)
	unsigned long                                      bSpawningActive : 1;                                      // 0x01D8(0x0004) (Net)
	int                                                DestroyAllCount;                                          // 0x01DC(0x0004) (Net)
...
public:
	...
	unsigned long                                      bSkipDefaultPhysMatParticleSystem : 1;                    // 0x003C(0x0004) (Edit)
	...
	class USoundCue*                                   ExplosionSoundHurtSomeone;                                // 0x00A4(0x0004) (Edit)
	class UPointLightComponent*                        ExploLight;                                               // 0x00A8(0x0004) (Edit, ExportObject, Component, EditInline)
	float                                              ExploLightFadeOutTime;                                    // 0x00AC(0x0004) (Edit)
	class URadialBlurComponent*                        ExploRadialBlur;                                          // 0x00B0(0x0004) (Edit, ExportObject, Component, EditInline)
	float                                              ExploRadialBlurFadeOutTime;                               // 0x00B4(0x0004) (Edit)
	float                                              ExploRadialBlurMaxBlur;                                   // 0x00B8(0x0004) (Edit)
	float                                              FractureMeshRadius;                                       // 0x00BC(0x0004) (Edit)
	float                                              FracturePartVel;                                          // 0x00C0(0x0004) (Edit)
	class UCameraShake*                                CamShake;                                                 // 0x00C4(0x0004) (Edit, EditInline)
	class UCameraShake*                                CamShake_Left;                                            // 0x00C8(0x0004) (Edit, EditInline)
	class UCameraShake*                                CamShake_Right;                                           // 0x00CC(0x0004) (Edit, EditInline)
	class UCameraShake*                                CamShake_Rear;                                            // 0x00D0(0x0004) (Edit, EditInline)
	float                                              CamShakeInnerRadius;                                      // 0x00D4(0x0004) (Edit)
	float                                              CamShakeOuterRadius;                                      // 0x00D8(0x0004) (Edit)
	float                                              CamShakeFalloff;                                          // 0x00DC(0x0004) (Edit)
	class UClass*                                      CameraLensEffect;                                         // 0x00E0(0x0004) (Edit)
	float                                              CameraLensEffectRadius;                                   // 0x00E4(0x0004) (Edit)
...
public:
	...
	unsigned long                                      bTrackExplosionParticleSystemLifespan : 1;                // 0x01D4(0x0004)
	...
	class URadialBlurComponent*                        ExplosionRadialBlur;                                      // 0x01DC(0x0004) (ExportObject, Transient, Component, EditInline)
	float                                              LightFadeTime;                                            // 0x01E0(0x0004) (Transient)
	float                                              LightFadeTimeRemaining;                                   // 0x01E4(0x0004) (Transient)
	float                                              LightInitialBrightness;                                   // 0x01E8(0x0004) (Transient)
...
{
public:
	unsigned long                                      bLastHitWasHeadShot : 1;                                  // 0x0464(0x0004) (Net, Transient)
	unsigned long                                      bRespondToExplosions : 1;                                 // 0x0464(0x0004)
...
// 0x0034 (0x064C - 0x0618)
class ADebugCameraController : public AGamePlayerController
{
public:
	struct FName                                       PrimaryKey;                                               // 0x0618(0x0008) (Config, GlobalConfig)
	struct FName                                       SecondaryKey;                                             // 0x0620(0x0008) (Config, GlobalConfig)
	struct FName                                       UnselectKey;                                              // 0x0628(0x0008) (Config, GlobalConfig)
	unsigned long                                      bShowSelectedInfo : 1;                                    // 0x0630(0x0004) (Config, GlobalConfig)
	unsigned long                                      bDrawDebugText : 1;                                       // 0x0630(0x0004)
	unsigned long                                      bIsFrozenRendering : 1;                                   // 0x0630(0x0004)
	class UClass*                                      HUDClass;                                                 // 0x0634(0x0004)
	class APlayerController*                           OriginalControllerRef;                                    // 0x0638(0x0004)
	class UPlayer*                                     OriginalPlayer;                                           // 0x063C(0x0004)
	class UDrawFrustumComponent*                       DrawFrustum;                                              // 0x0640(0x0004) (ExportObject, Component, EditInline)
	class AActor*                                      SelectedActor;                                            // 0x0644(0x0004)
	class UPrimitiveComponent*                         SelectedComponent;                                        // 0x0648(0x0004) (ExportObject, Component, EditInline)
...
public:
	...
	unsigned long                                      bApplyGlobalScaleToActiveSizes : 1;                       // 0x0080(0x0004) (Edit, Config)
	...
	unsigned long                                      bSliderHasTrack : 1;                                      // 0x0080(0x0004) (Edit, Config)
	...
	float                                              InitialX;                                                 // 0x009C(0x0004) (Const)
	float                                              InitialY;                                                 // 0x00A0(0x0004) (Const)
	float                                              InitialSizeX;                                             // 0x00A4(0x0004) (Const)
	float                                              InitialSizeY;                                             // 0x00A8(0x0004) (Const)
	float                                              InitialActiveSizeX;                                       // 0x00AC(0x0004) (Const)
	float                                              InitialActiveSizeY;                                       // 0x00B0(0x0004) (Const)
	float                                              AuthoredGlobalScale;                                      // 0x00B4(0x0004) (Edit, Config)
	float                                              Border;                                                   // 0x00B8(0x0004) (Edit, Config)
	float                                              ResetCenterAfterInactivityTime;                           // 0x00BC(0x0004) (Edit, Config)
	float                                              TapDistanceConstraint;                                    // 0x00C0(0x0004) (Edit, Config)
	float                                              ActivateTime;                                             // 0x00C4(0x0004) (Edit, Config)
	float                                              DeactivateTime;                                           // 0x00C8(0x0004) (Edit, Config)
	struct FColor                                      RenderColor;                                              // 0x00CC(0x0004) (Edit, Config)
	float                                              InactiveAlpha;                                            // 0x00D0(0x0004) (Edit, Config)
	float                                              CaptionXAdjustment;                                       // 0x00D4(0x0004) (Edit, Config)
	float                                              CaptionYAdjustment;                                       // 0x00D8(0x0004) (Edit, Config)
	class UTexture2D*                                  OverrideTexture1;                                         // 0x00DC(0x0004) (Edit)
	struct FString                                     OverrideTexture1Name;                                     // 0x00E0(0x000C) (Config, NeedCtorLink)
	struct FTextureUVs                                 OverrideUVs1;                                             // 0x00EC(0x0010) (Edit, Config)
	class UTexture2D*                                  OverrideTexture2;                                         // 0x00FC(0x0004) (Edit)
	struct FString                                     OverrideTexture2Name;                                     // 0x0100(0x000C) (Config, NeedCtorLink)
	struct FTextureUVs                                 OverrideUVs2;                                             // 0x010C(0x0010) (Edit, Config)
	...
	TArray<class USeqEvent_MobileZoneBase*>            MobileSeqEventHandlers;                                   // 0x01A4(0x000C) (NeedCtorLink)
	struct FVector2D                                   LastAxisValues;                                           // 0x01B0(0x0008)
	float                                              TotalActiveTime;                                          // 0x01B8(0x0004)
	float                                              LastWentActiveTime;                                       // 0x01BC(0x0004)
	struct FScriptDelegate                             __OnProcessInputDelegate__Delegate;                       // 0x01C0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnTapDelegate__Delegate;                                // 0x01CC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnDoubleTapDelegate__Delegate;                          // 0x01D8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnProcessSlide__Delegate;                               // 0x01E4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPreDrawZone__Delegate;                                // 0x01F0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPostDrawZone__Delegate;                               // 0x01FC(0x000C) (NeedCtorLink)
...
public:
	...
	float                                              AuthoredGlobalScale;                                      // 0x0060(0x0004) (Edit)
	...
	struct FString                                     Tag;                                                      // 0x007C(0x000C) (NeedCtorLink)
	...
	struct FString                                     RelativeToTag;                                            // 0x0094(0x000C) (NeedCtorLink)
...
public:
	...
	float                                              Opacity;                                                  // 0x0088(0x0004) (Edit)
	class USoundCue*                                   UITouchSound;                                             // 0x008C(0x0004) (Edit)
	class USoundCue*                                   UIUnTouchSound;                                           // 0x0090(0x0004) (Edit)
...
{
public:
	struct FTouchData                                  Touches[0x5];                                             // 0x0268(0x0048) (Edit, NeedCtorLink)
	class UMobileMenuObject*                           InteractiveObject;                                        // 0x03D0(0x0004)
	struct FDouble                                     InteractiveObjectLastTime;                                // 0x03D4(0x0008)
	TArray<struct FMobileInputGroup>                   MobileInputGroups;                                        // 0x03DC(0x000C) (Edit, NeedCtorLink, EditInline)
	int                                                CurrentMobileGroup;                                       // 0x03E8(0x0004) (Edit)
	TArray<class UMobileInputZone*>                    MobileInputZones;                                         // 0x03EC(0x000C) (Edit, NeedCtorLink, EditInline)
	TArray<struct FMobileInputZoneClassMap>            MobileInputZoneClasses;                                   // 0x03F8(0x000C) (NeedCtorLink)
	float                                              MobilePitch;                                              // 0x0404(0x0004) (Edit)
	float                                              MobilePitchCenter;                                        // 0x0408(0x0004) (Edit)
	float                                              MobilePitchMultiplier;                                    // 0x040C(0x0004) (Edit)
	float                                              MobileYaw;                                                // 0x0410(0x0004) (Edit)
	float                                              MobileYawCenter;                                          // 0x0414(0x0004) (Edit)
	float                                              MobileYawMultiplier;                                      // 0x0418(0x0004) (Edit)
	float                                              MobilePitchDeadzoneSize;                                  // 0x041C(0x0004) (Edit, Config)
	float                                              MobileYawDeadzoneSize;                                    // 0x0420(0x0004) (Edit, Config)
	float                                              MobileDoubleTapTime;                                      // 0x0424(0x0004) (Edit, Config)
	float                                              MobileMinHoldForTap;                                      // 0x0428(0x0004) (Edit, Config)
	float                                              MobileTapRepeatTime;                                      // 0x042C(0x0004) (Edit, Config)
	unsigned long                                      bAllowTouchesInCinematic : 1;                             // 0x0430(0x0004) (Edit)
	unsigned long                                      bDisableTouchInput : 1;                                   // 0x0430(0x0004) (Edit)
	unsigned long                                      bAbsoluteTouchLocations : 1;                              // 0x0430(0x0004) (Edit, Config)
	unsigned long                                      bCollapseTouchInput : 1;                                  // 0x0430(0x0004) (Edit, Config)
	unsigned long                                      bFakeMobileTouches : 1;                                   // 0x0430(0x0004) (Edit)
	unsigned long                                      bDisableSceneRender : 1;                                  // 0x0430(0x0004) (Edit)
	float                                              ZoneTimeout;                                              // 0x0434(0x0004) (Edit, Config)
	TArray<class UMobileMenuScene*>                    MobileMenuStack;                                          // 0x0438(0x000C) (Edit, NeedCtorLink)
	struct FString                                     NativeDebugString;                                        // 0x0444(0x000C) (Edit, NeedCtorLink)
	float                                              MobileInactiveTime;                                       // 0x0450(0x0004) (Edit)
	TArray<class USeqEvent_MobileBase*>                MobileSeqEventHandlers;                                   // 0x0454(0x000C) (Edit, NeedCtorLink)
	TArray<class USeqEvent_MobileRawInput*>            MobileRawInputSeqEventHandlers;                           // 0x0460(0x000C) (Edit, NeedCtorLink)
	struct FVector2D                                   MobileViewportOffset;                                     // 0x046C(0x0008)
	struct FVector2D                                   MobileViewportSize;                                       // 0x0474(0x0008)
	struct FScriptDelegate                             __OnTouchNotHandledInMenu__Delegate;                      // 0x047C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPreviewTouch__Delegate;                               // 0x0488(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnInputTouch__Delegate;                                 // 0x0494(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     MovieName;                                                // 0x0110(0x000C) (Edit, NeedCtorLink)
	int                                                StartOfRenderingMovieFrame;                               // 0x011C(0x0004) (Edit)
	int                                                EndOfRenderingMovieFrame;                                 // 0x0120(0x0004) (Edit)
...
{
public:
	float                                              ScreenX;                                                  // 0x00FC(0x0004) (Edit)
	float                                              ScreenY;                                                  // 0x0100(0x0004) (Edit)
	float                                              TraceDistance;                                            // 0x0104(0x0004) (Edit)
...
{
public:
	float                                              WarmupPopulationPct;                                      // 0x00FC(0x0004) (Edit)
	class UGameCrowd_ListOfAgents*                     CrowdAgentList;                                           // 0x0100(0x0004) (Edit)
	unsigned long                                      bClearOldArchetypes : 1;                                  // 0x0104(0x0004) (Edit)
	unsigned long                                      bEnableCrowdLightEnvironment : 1;                         // 0x0104(0x0004) (Edit)
	unsigned long                                      bCastShadows : 1;                                         // 0x0104(0x0004) (Edit)
	unsigned long                                      bFillPotentialSpawnPoints : 1;                            // 0x0104(0x0004)
	unsigned long                                      bForceObstacleChecking : 1;                               // 0x0104(0x0004) (Edit)
	unsigned long                                      bForceNavMeshPathing : 1;                                 // 0x0104(0x0004) (Edit)
	unsigned long                                      bIndividualSpawner : 1;                                   // 0x0104(0x0004)
	int                                                MaxAgents;                                                // 0x0108(0x0004) (Edit)
	float                                              SpawnRate;                                                // 0x010C(0x0004) (Edit)
	struct FLightingChannelContainer                   AgentLightingChannel;                                     // 0x0110(0x0004)
	float                                              MaxSpawnDist;                                             // 0x0114(0x0004) (Edit)
	float                                              MinBehindSpawnDist;                                       // 0x0118(0x0004)
	TArray<class AGameCrowdDestination*>               PotentialSpawnPoints;                                     // 0x011C(0x000C) (NeedCtorLink)
	float                                              AgentWarmupTime;                                          // 0x0128(0x0004)
	int                                                NumAgentsToTickPerFrame;                                  // 0x012C(0x0004) (Edit)
	TArray<class AGameCrowdAgent*>                     LastSpawnedList;                                          // 0x0130(0x000C) (NeedCtorLink)
...
{
public:
	struct FName                                       ZoneName;                                                 // 0x00FC(0x0008) (Edit)
	class UMobileInputZone*                            NewZone;                                                  // 0x0104(0x0004) (Edit, EditInline)
...
{
public:
	struct FString                                     ZoneName;                                                 // 0x00FC(0x000C) (Edit, NeedCtorLink)
...
{
public:
	TArray<struct FPropertyInfo>                       Properties;                                               // 0x00FC(0x000C) (Edit, NeedCtorLink, EditInline)
...
{
public:
	TArray<struct FName>                               AnimationList;                                            // 0x0110(0x000C) (Edit, NeedCtorLink)
	float                                              BlendInTime;                                              // 0x011C(0x0004) (Edit)
	float                                              BlendOutTime;                                             // 0x0120(0x0004) (Edit)
	unsigned long                                      bUseRootMotion : 1;                                       // 0x0124(0x0004) (Edit)
	unsigned long                                      bFaceActionTargetFirst : 1;                               // 0x0124(0x0004) (Edit)
	unsigned long                                      bLooping : 1;                                             // 0x0124(0x0004) (Edit)
	unsigned long                                      bBlendBetweenAnims : 1;                                   // 0x0124(0x0004) (Edit)
	int                                                LoopIndex;                                                // 0x0128(0x0004) (Edit)
	float                                              LoopTime;                                                 // 0x012C(0x0004) (Edit)
...
{
public:
	TArray<class UObject*>                             Targets;                                                  // 0x0114(0x000C) (Edit, NeedCtorLink)
	unsigned long                                      bIsActive : 1;                                            // 0x0120(0x0004) (Edit)
	float                                              AuthoredGlobalScale;                                      // 0x0124(0x0004) (Edit)
...
{
public:
	struct FString                                     TargetZoneName;                                           // 0x0114(0x000C) (Edit, NeedCtorLink)
...
public:
	...
	unsigned long                                      bSendPressedOnlyOnTouchDown : 1;                          // 0x0120(0x0004) (Edit)
	unsigned long                                      bSendPressedOnlyOnTouchUp : 1;                            // 0x0120(0x0004) (Edit)
...
{
public:
	int                                                TouchIndex;                                               // 0x0114(0x0004) (Edit)
	int                                                TouchpadIndex;                                            // 0x0118(0x0004) (Edit)
...
{
public:
	float                                              TraceDistance;                                            // 0x0128(0x0004) (Edit)
	unsigned long                                      bCheckonTouch : 1;                                        // 0x012C(0x0004) (Edit)
	...
	TArray<class UObject*>                             Targets;                                                  // 0x014C(0x000C) (Edit, NeedCtorLink)
...
{
public:
	float                                              Tolerance;                                                // 0x0128(0x0004) (Edit)
	float                                              MinDistance;                                              // 0x012C(0x0004) (Edit)
	struct FVector2D                                   InitialTouch;                                             // 0x0130(0x0008)
	TArray<class AActor*>                              TouchedActors;                                            // 0x0138(0x000C) (Edit, NeedCtorLink)
	float                                              TraceDistance;                                            // 0x0144(0x0004) (Edit)
...
public:
	...
	void OnBecomeInActive(class APawn* P, class UGameCameraBase* NewCamera);
...
public:
	...
	struct FVector                                     LastWorstLocation;                                        // 0x015C(0x000C) (Transient)
	struct FVector                                     LastPreModifierCameraLoc;                                 // 0x0168(0x000C) (Transient)
	struct FRotator                                    LastPreModifierCameraRot;                                 // 0x0174(0x000C) (Transient)
	TArray<struct FPenetrationAvoidanceFeeler>         PenetrationAvoidanceFeelers;                              // 0x0180(0x000C) (Edit, NeedCtorLink)
	struct FVector                                     LastOffsetAdjustment;                                     // 0x018C(0x000C) (Transient)
...
{
public:
	class UGameCameraBase*                             ThirdPersonCam;                                           // 0x04B0(0x0004) (Edit, Transient, EditInline)
	class UClass*                                      ThirdPersonCameraClass;                                   // 0x04B4(0x0004) (Edit, Const)
	class UGameCameraBase*                             FixedCam;                                                 // 0x04B8(0x0004) (Edit, Transient, EditInline)
	class UClass*                                      FixedCameraClass;                                         // 0x04BC(0x0004) (Edit, Const)
	class UGameCameraBase*                             CurrentCamera;                                            // 0x04C0(0x0004) (Edit, Transient, EditInline)
	unsigned long                                      bUseForcedCamFOV : 1;                                     // 0x04C4(0x0004) (Transient)
	unsigned long                                      bInterpolateCamChanges : 1;                               // 0x04C4(0x0004) (Transient)
	unsigned long                                      bResetInterp : 1;                                         // 0x04C4(0x0004) (Transient)
	float                                              ForcedCamFOV;                                             // 0x04C8(0x0004) (Transient)
	class AActor*                                      LastViewTarget;                                           // 0x04CC(0x0004) (Transient)
	float                                              SplitScreenShakeScale;                                    // 0x04D0(0x0004) (Edit, Const)
	class AActor*                                      LastTargetBase;                                           // 0x04D4(0x0004) (Transient)
	unsigned char                                      UnknownData00[0x8];                                       // 0x04D8(0x0008) MISSED OFFSET
	struct FMatrix                                     LastTargetBaseTM;                                         // 0x04E0(0x0040) (Transient)
...
public:
	...
	struct FItemEvents                                 AllItemEvents;                                            // 0x0230(0x0048) (Const, NeedCtorLink)
...
{
public:
	unsigned long                                      bDrawDebugText : 1;                                       // 0x045C(0x0004)
...
{
public:
	int                                                OldMobileGroup;                                           // 0x064C(0x0004)
	class UMobilePlayerInput*                          MPI;                                                      // 0x0650(0x0004)
...
{
public:
	unsigned long                                      bDrawDebugText : 1;                                       // 0x0548(0x0004)
...
{
public:
	unsigned long                                      bIsVertical : 1;                                          // 0x00A4(0x0004) (Edit)
	unsigned long                                      bDirty : 1;                                               // 0x00A4(0x0004)
	int                                                SelectedIndex;                                            // 0x00A8(0x0004) (Edit)
	int                                                FirstItem;                                                // 0x00AC(0x0004)
	TArray<class UMobileMenuBarItem*>                  Items;                                                    // 0x00B0(0x000C) (NeedCtorLink)
...
public:
	...
	struct FString                                     Caption;                                                  // 0x00E4(0x000C) (NeedCtorLink)
...
{
public:
	class UClass*                                      InitialSceneToDisplayClass;                               // 0x039C(0x0004)
...
{
public:
	TArray<class UMobileMenuElement*>                  Slots;                                                    // 0x00A4(0x000C) (NeedCtorLink)
	TArray<class UMobileMenuElement*>                  Items;                                                    // 0x00B0(0x000C) (NeedCtorLink)
	...
	struct FScriptDelegate                             __OnUpdateItemInSlot__Delegate;                           // 0x00FC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __DoCanPutItemInSlot__Delegate;                           // 0x0108(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateDrag__Delegate;                                 // 0x0114(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     Caption;                                                  // 0x00A4(0x000C) (NeedCtorLink)
...
{
public:
	unsigned long                                      bIsVerticalList : 1;                                      // 0x00A4(0x0004) (Edit)
	unsigned long                                      bDisableScrolling : 1;                                    // 0x00A4(0x0004) (Edit)
	unsigned long                                      bForceSelectedToLineup : 1;                               // 0x00A4(0x0004) (Edit)
	unsigned long                                      bTapToScrollToItem : 1;                                   // 0x00A4(0x0004)
	unsigned long                                      bLoops : 1;                                               // 0x00A4(0x0004)
	float                                              SelectedOffset;                                           // 0x00A8(0x0004) (Edit)
	TArray<class UMobileMenuListItem*>                 Items;                                                    // 0x00AC(0x000C) (NeedCtorLink)
...
{
public:
	struct FScriptDelegate                             __OnTouchEvent__Delegate;                                 // 0x00A4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnRenderObject__Delegate;                               // 0x00B0(0x000C) (NeedCtorLink)
...
{
public:
	unsigned long                                      bEnabled : 1;                                             // 0x0200(0x0004)
...
{
public:
	int                                                NumberOfClientsToWaitFor;                                 // 0x039C(0x0004)
	struct FString                                     URLToLoad;                                                // 0x03A0(0x000C) (NeedCtorLink)
...
{
public:
	struct FLinearColor                                DisplayColor;                                             // 0x0128(0x0010) (Edit)
	struct FVector                                     DisplayLocation;                                          // 0x0138(0x000C) (Edit)
	class UTexture2D*                                  DisplayTexture;                                           // 0x0144(0x0004) (Edit)
	float                                              XL;                                                       // 0x0148(0x0004) (Edit)
	float                                              YL;                                                       // 0x014C(0x0004) (Edit)
	float                                              U;                                                        // 0x0150(0x0004) (Edit)
	float                                              V;                                                        // 0x0154(0x0004) (Edit)
	float                                              UL;                                                       // 0x0158(0x0004) (Edit)
	float                                              VL;                                                       // 0x015C(0x0004) (Edit)
...
{
public:
	class UFont*                                       DisplayFont;                                              // 0x0128(0x0004) (Edit)
	struct FColor                                      DisplayColor;                                             // 0x012C(0x0004) (Edit)
	struct FVector                                     DisplayLocation;                                          // 0x0130(0x000C) (Edit)
	struct FString                                     DisplayText;                                              // 0x013C(0x000C) (Edit, NeedCtorLink)
	TEnumAsByte<ETextDrawMethod>                       TextDrawMethod;                                           // 0x0148(0x0001) (Edit)
