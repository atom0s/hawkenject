...
// Function GFxUI.GFxMoviePlayer.GetPriority
// (Defined, Public)
// Parameters:
// unsigned char                  ReturnValue                    (Parm, OutParm, ReturnParm)

unsigned char UGFxMoviePlayer::GetPriority()
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.GetPriority");

	UGFxMoviePlayer_GetPriority_Params params;
...
// Function GFxUI.GFxMoviePlayer.DrawVisibleFrameRect
// (Defined, HasOptionalParms, Public)
// Parameters:
// class UCanvas*                 C                              (Parm)
// struct FColor                  OutlineColor                   (OptionalParm, Parm)
// struct FColor                  TextColor                      (OptionalParm, Parm)

void UGFxMoviePlayer::DrawVisibleFrameRect(class UCanvas* C, const struct FColor& OutlineColor, const struct FColor& TextColor)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.DrawVisibleFrameRect");

	UGFxMoviePlayer_DrawVisibleFrameRect_Params params;
	params.C = C;
...
// Function GFxUI.GFxMoviePlayer.DrawMovieViewportOutline
...
void UGFxMoviePlayer::DrawMovieViewportOutline(class UCanvas* C, const struct FColor& OutlineColor, const struct FColor& TextColor)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.DrawMovieViewportOutline");

	UGFxMoviePlayer_DrawMovieViewportOutline_Params params;
	params.C = C;
	params.OutlineColor = OutlineColor;
	params.TextColor = TextColor;
...
// Function GFxUI.GFxMoviePlayer.LogVisibleFrameInfo
// (HasOptionalParms, Public)
// Parameters:
// struct FString                 LogDebugName                   (OptionalParm, Parm, NeedCtorLink)

void UGFxMoviePlayer::LogVisibleFrameInfo(const struct FString& LogDebugName)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.LogVisibleFrameInfo");

	UGFxMoviePlayer_LogVisibleFrameInfo_Params params;
	params.LogDebugName = LogDebugName;
...
// Function GFxUI.GFxMoviePlayer.LogMovieViewportInfo
// (HasOptionalParms, Public)
// Parameters:
// struct FString                 LogDebugName                   (OptionalParm, Parm, NeedCtorLink)

void UGFxMoviePlayer::LogMovieViewportInfo(const struct FString& LogDebugName)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.LogMovieViewportInfo");

	UGFxMoviePlayer_LogMovieViewportInfo_Params params;
	params.LogDebugName = LogDebugName;
...
// Function GFxUI.GFxMoviePlayer.GetViewScaleMode
// (Final, Native, Public)
// Parameters:
// TEnumAsByte<EGFxScaleMode>     ReturnValue                    (Parm, OutParm, ReturnParm)

TEnumAsByte<EGFxScaleMode> UGFxMoviePlayer::GetViewScaleMode()
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.GetViewScaleMode");
...
// Function GFxUI.GFxMoviePlayer.GetAlignment
// (Final, Native, Public)
// Parameters:
// TEnumAsByte<EGFxAlign>         ReturnValue                    (Parm, OutParm, ReturnParm)

TEnumAsByte<EGFxAlign> UGFxMoviePlayer::GetAlignment()
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.GetAlignment");
...
// Function GFxUI.GFxMoviePlayer.GetPerspective3D
// (Final, Native, Public, HasOutParms)
// Parameters:
// struct FMatrix                 matPersp                       (Parm, OutParm)

void UGFxMoviePlayer::GetPerspective3D(struct FMatrix* matPersp)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.GetPerspective3D");
...
// Function GFxUI.GFxMoviePlayer.GetView3D
// (Final, Native, Public, HasOutParms)
// Parameters:
// struct FMatrix                 matView                        (Parm, OutParm)

void UGFxMoviePlayer::GetView3D(struct FMatrix* matView)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.GetView3D");
...
// (Final, Native, Public, HasOutParms)
// Parameters:
// struct FMovieViewportMirror    out_Viewport                   (Parm, OutParm)
// bool                           ReturnValue                    (Parm, OutParm, ReturnParm)

bool UGFxMoviePlayer::GetViewport(struct FMovieViewportMirror* out_Viewport)
{
	...
	if (out_Viewport != nullptr)
		*out_Viewport = params.out_Viewport;
...
// Function GFxUI.GFxMoviePlayer.ScreenResized
// (Defined, Event, Public, HasOutParms)
// Parameters:
// int                            ViewportSizeX                  (Parm)
// int                            ViewportSizeY                  (Parm)
// int                            RenderTargetSizeX              (Parm, OutParm)
// int                            RenderTargetSizeY              (Parm, OutParm)
// bool                           ReturnValue                    (Parm, OutParm, ReturnParm)

bool UGFxMoviePlayer::ScreenResized(int ViewportSizeX, int ViewportSizeY, int* RenderTargetSizeX, int* RenderTargetSizeY)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.ScreenResized");

	UGFxMoviePlayer_ScreenResized_Params params;
	...
	if (RenderTargetSizeX != nullptr)
		*RenderTargetSizeX = params.RenderTargetSizeX;
	if (RenderTargetSizeY != nullptr)
		*RenderTargetSizeY = params.RenderTargetSizeY;
...
// Parameters:
// bool                           bStereoEnabledNow              (Parm)

void UGFxObject::FixStereoFOV(bool bStereoEnabledNow)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxObject.FixStereoFOV");

	UGFxObject_FixStereoFOV_Params params;
	params.bStereoEnabledNow = bStereoEnabledNow;
