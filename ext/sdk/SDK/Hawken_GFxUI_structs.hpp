...
// ScriptStruct GFxUI.GFxMoviePlayer.MovieViewportMirror
// 0x0034
struct FMovieViewportMirror
{
	int                                                BufferWidth;                                              // 0x0000(0x0004) (AlwaysInit)
	int                                                BufferHeight;                                             // 0x0004(0x0004) (AlwaysInit)
	int                                                ViewportLeft;                                             // 0x0008(0x0004) (AlwaysInit)
	int                                                ViewportTop;                                              // 0x000C(0x0004) (AlwaysInit)
	int                                                ViewportWidth;                                            // 0x0010(0x0004) (AlwaysInit)
	int                                                ViewportHeight;                                           // 0x0014(0x0004) (AlwaysInit)
	int                                                ScissorLeft;                                              // 0x0018(0x0004) (AlwaysInit)
	int                                                ScissorTop;                                               // 0x001C(0x0004) (AlwaysInit)
	int                                                ScissorWidth;                                             // 0x0020(0x0004) (AlwaysInit)
	int                                                ScissorHeight;                                            // 0x0024(0x0004) (AlwaysInit)
	int                                                MovieViewportFlags;                                       // 0x0028(0x0004) (AlwaysInit)
	float                                              MovieViewportScale;                                       // 0x002C(0x0004) (AlwaysInit)
	float                                              MovieViewportAspectRatio;                                 // 0x0030(0x0004) (AlwaysInit)
};
...
struct FASValue
{
	...
	struct FString                                     S;                                                        // 0x0010(0x000C) (Edit, AlwaysInit, NeedCtorLink)
};
...
struct FSoundThemeBinding
{
	...
	struct FString                                     ThemeClassName;                                           // 0x000C(0x000C) (Edit, NeedCtorLink)
};
...
struct FASDisplayInfo
{
	...
	unsigned long                                      hasFOV : 1;                                               // 0x0028(0x0004) (Edit)
	unsigned long                                      hasViewMatrix : 1;                                        // 0x0028(0x0004) (Edit)
	unsigned long                                      hasProjectionMatrix : 1;                                  // 0x0028(0x0004) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FMatrix                                     ViewMatrix3D;                                             // 0x0030(0x0040) (Edit)
	struct FMatrix                                     ProjectionMatrix3D;                                       // 0x0070(0x0040) (Edit)
	float                                              FOV;                                                      // 0x00B0(0x0004) (Edit)
};
...
struct FEventData
{
	...
	struct FString                                     Type;                                                     // 0x0008(0x000C) (NeedCtorLink)
