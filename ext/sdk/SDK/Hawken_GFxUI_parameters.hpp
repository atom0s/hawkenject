...
struct UGFxMoviePlayer_GetPriority_Params
{
	unsigned char                                      ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function GFxUI.GFxMoviePlayer.DrawVisibleFrameRect
struct UGFxMoviePlayer_DrawVisibleFrameRect_Params
{
...
struct UGFxMoviePlayer_DrawMovieViewportOutline_Params
{
	class UCanvas*                                     C;                                                        // (Parm)
	struct FColor                                      OutlineColor;                                             // (OptionalParm, Parm)
	struct FColor                                      TextColor;                                                // (OptionalParm, Parm)
...
struct UGFxMoviePlayer_ScreenResized_Params
{
...
struct UGFxObject_FixStereoFOV_Params
{
